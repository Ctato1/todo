...
export default function TodoItem({
  ...
  return (
    <div className="gap-2 flex items-center overflow-hidden">
      <label
        className={`flex grow gap-2 items-center border rounded-md p-3 border-gray-400 bg-white hover:bg-slate-50 cursor-pointer ${
          animation === todo.id ? "animate-pulse" : ""
        }`}
      >
        <input
          type="checkbox"
      ...
      <button className="p-2" onClick={() => onDeleteChange(todo.id)}>
